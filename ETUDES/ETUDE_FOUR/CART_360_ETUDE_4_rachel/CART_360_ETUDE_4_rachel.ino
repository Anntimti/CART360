...
int peakNote = 0; // pdf yet more arduino
    ...
    case 4:
      {
        ...
        analogWrite(LED_PIN_G, 125);   // Turn on the LED -G
        analogWrite(LED_PIN_B, 125);   // Turn on the LED -B
        break;
      }
    default:
      {
...
int getPhotoFrequency()
{
  ...
  int photoCell = analogRead(PHOTO_PIN);
  photoCell = map(photoCell, 0, 1024, 0, 800);
  return photoCell;
}
